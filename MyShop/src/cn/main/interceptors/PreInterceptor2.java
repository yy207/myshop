...
public class PreInterceptor2 extends HandlerInterceptorAdapter {
	Logger logger = Logger.getLogger(PreInterceptor2.class);
	...
	public boolean preHandle(HttpServletRequest request,
		...
		// 前置拦截
		logger.debug("SysInterceptor preHandle MainIndedx==========================");
